  ...
  return (
    <div className="bg-gray-900/70 border border-gray-700 rounded-3xl overflow-hidden">
      ...
      <div className="border-b border-gray-800 px-6 sm:px-10 py-8 animate-pulse">
        <div className="h-3 w-56 bg-gray-800/60 rounded-lg mb-3" />
        <div className="h-8 w-72 bg-gray-700/60 rounded-lg" />
      </div>
      ...
      <div className="border-b border-gray-800 px-6 sm:px-10 py-4 flex gap-2 animate-pulse">
        ...
        <div className="h-8 w-14 bg-gray-700/60 rounded-lg" />
        <div className="h-8 w-20 bg-gray-800/40 rounded-lg" />
      </div>
      ...
      <div className="border-b border-gray-800 px-6 sm:px-10 py-5 flex items-center justify-between animate-pulse">
        <div className="flex gap-2">
          ...
          <div className="h-6 w-24 bg-gray-800/60 rounded-full" />
          <div className="h-6 w-16 bg-gray-800/60 rounded-full" />
        </div>
        <div className="h-3 w-24 bg-gray-800/40 rounded-lg" />
      </div>
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              ...
              className={`flex items-center gap-4 px-5 py-4 animate-pulse ${
                i !== 5 ? 'border-b border-gray-800/80' : ''
              }`}
            >
              <div className="w-5 h-5 rounded bg-gray-800/60 shrink-0" />
              <div className="flex-1 h-4 bg-gray-700/60 rounded-lg min-w-0" />
              <div className="h-3 w-16 bg-gray-800/40 rounded-lg shrink-0" />
            </div>
          ))}
        </div>
      </div>
